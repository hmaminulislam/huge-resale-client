...
import image1 from "../../../assets/images/testimonial/test1.jpg";
import image2 from "../../../assets/images/testimonial/test2.jpg";
import image3 from "../../../assets/images/testimonial/test3.jpg";
                ...
                <section className="my-8 bg-gray-100 text-gray-800">
                  <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                    ...
                    <div className="flex justify-center items-center space-x-3">
                      ...
                      />
                      <div>
                        <p className="leading-tight">{test.name}</p>
